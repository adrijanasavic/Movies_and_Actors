...
public class AdapterFilmovi extends RecyclerView.Adapter<AdapterFilmovi.MyViewHolder> {
    ...
    public AdapterFilmovi(Context context, List<ResultsMovieItem> searchItems, OnItemClickListener listener) {
