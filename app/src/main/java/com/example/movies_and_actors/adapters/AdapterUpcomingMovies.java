...
public class AdapterUpcomingMovies extends RecyclerView.Adapter<AdapterUpcomingMovies.MyViewHolder> {
    ...
    public AdapterUpcomingMovies(Context context, List<ResultsMovieItem> searchItems) {
